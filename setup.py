...
setup (name = 'VVCORElib_seq_h5',
       version = '1.0',
       description = 'This is version of VVCORE with sequential reading of csv LAMMPS outputs',
       packages=['VVCORElib_seq_h5'],
       ext_modules = [rho_j_k_d_ext, rho_j_k_s_ext],
       scripts=['VVCORE_seq_h5', 'VVCORE_seq_h5_reduce', 'VVCORE_seq_h5_auto', 'VVCORE_seq_h5_collect', 'VVCORE_seq_h5_ift'],
       install_requires=['numpy', 'scipy', 'psutil', 'h5py'])
